    ...
    <section className="wallets">
      ...
      <div className="wallet-card">
        ...
        <div className="market-table">
          ...
          {(Array.isArray(treasury.onchain) ? treasury.onchain : []).map((row) => (
        ...
        <div className="market-table">
          ...
          {(Array.isArray(treasury.userFunds) ? treasury.userFunds : []).map((row) => (
        ...
        <div className="market-table">
          ...
          {(Array.isArray(treasury.platformFees) ? treasury.platformFees : []).map((row) => (
        ...
        {treasury.treasuryAddresses?.length > 0 && (
          <div className="market-table">
            ...
            {(Array.isArray(treasury.treasuryAddresses) ? treasury.treasuryAddresses : []).map((row) => (
      ...
      <div className="wallet-card">
        ...
        <div className="market-table">
          ...
          {(Array.isArray(paymentProviders) ? paymentProviders : []).map((item) => (
            <div className="market-row" key={item.id}>
              <span>{item.name}</span>
      ...
      <div className="wallet-card">
        ...
        <div className="market-table">
          ...
          {(Array.isArray(health) ? health : []).map((item) =>
            (Array.isArray(item.checks) ? item.checks : []).map((check, idx) => (
      ...
      <div className="wallet-card">
        ...
        <div className="market-table">
          ...
          {(Array.isArray(fiats) ? fiats : []).map((fiat) => (
      ...
      <div className="wallet-card">
        ...
        <div className="market-table">
          ...
          {(Array.isArray(pendingWithdrawals) ? pendingWithdrawals : []).map((item) => (
            <div className="market-row" key={item.id}>
